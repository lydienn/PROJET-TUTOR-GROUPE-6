            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item">
                            <a href="expédition.php" class="nav__link active-link">Expédier</a>
                        </li>
                        <li class="nav__item">
                            <a href="suivre.php" class="nav__link">Suivre</a>
                        </li>
                        <li class="nav__item">
                ...
                <a href="./expedition" class="button button__header">Expédier!</a>
            </nav>
        </header>

        <main class="main"><br><br><br><br><br>
        
           <form action="https://api.monetbil.com/pay/v2.1/NzYApSdSrj4tFMShQ8EeQo1uHqAmSExt" method="POST" data-monetbil="form">
                <input type="number" placeholder="prix" name="amount">
